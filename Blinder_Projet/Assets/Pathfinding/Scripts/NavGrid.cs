...
namespace Pathfinding
{
    ...
    public class NavGrid : NodeGrid
    {
        ...
        public int LineCast(Vector2i start, Vector2i end, Vector2i[] bufferArray)
        {
            ClearRayTrace(start.x, start.y, end.x, end.y);
        ...
        // source : http://playtechs.blogspot.nl/2007/03/raytracing-on-grid.html
        private int IntRayTrace(int x0, int y0, int x1, int y1, Vector2i[] bufferArray)
        {
            int currentIndex = 0;
        ...
        // source : http://playtechs.blogspot.nl/2007/03/raytracing-on-grid.html
        private bool ClearRayTrace(int x0, int y0, int x1, int y1)
        {
            int currentIndex = 0;
